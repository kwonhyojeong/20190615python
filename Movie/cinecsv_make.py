...
while int(movieDate)//10000 != 2018:
    url = f"http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=809cc94b053d3a0109cd51a88b9fd192&targetDt={movieDate}"
